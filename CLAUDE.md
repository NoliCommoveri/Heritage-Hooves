...
| Conformation (one polygenic trait) | specified, not built | Expression and display for the four conformation traits, which every horse already carries and nothing shows. See `docs/slices/0006-conformation.md`. |
