...
describe('parseAllelePool', () => {
  it('parses a well-formed pool', () => {
    const pool = parseAllelePool(
      '{"E":{"E":0.55,"e":0.45},"A":{"A":0.45,"a":0.55},"CR":{"Cr":0.10,"cr":0.90},"G":{"G":0.03,"g":0.97},"DMRT3":{"C":0.98,"A":0.02},"HYPP":{"N":1.0},"PSSM1":{"N":1.0},"HERDA":{"N":1.0},"GBED":{"N":1.0},"D":{"nd":1.0},"Z":{"z":1.0},"CH":{"ch":1.0},"RN":{"rn":1.0},"TO":{"n":1.0},"O":{"n":1.0},"SW1":{"n":1.0},"SB1":{"n":1.0},"LP":{"lp":1.0},"PATN1":{"n":1.0},"SCID":{"N":1.0},"CA":{"N":1.0},"LFS":{"N":1.0},"WFFS":{"N":1.0},"DWARF":{"N":1.0},"HYDRO":{"N":1.0},"DSLD":{"N":1.0}}'
    );
  ...
  it('accepts a locus fixed for a single allele', () => {
    const pool = parseAllelePool(
      '{"E":{"E":0.92,"e":0.08},"A":{"a":1.0},"CR":{"cr":1.0},"G":{"g":1.0},"DMRT3":{"C":1.0},"HYPP":{"N":1.0},"PSSM1":{"N":1.0},"HERDA":{"N":1.0},"GBED":{"N":1.0},"D":{"nd":1.0},"Z":{"z":1.0},"CH":{"ch":1.0},"RN":{"rn":1.0},"TO":{"n":1.0},"O":{"n":1.0},"SW1":{"n":1.0},"SB1":{"n":1.0},"LP":{"lp":1.0},"PATN1":{"n":1.0},"SCID":{"N":1.0},"CA":{"N":1.0},"LFS":{"N":1.0},"WFFS":{"N":1.0},"DWARF":{"N":1.0},"HYDRO":{"N":1.0},"DSLD":{"N":1.0}}'
    );
