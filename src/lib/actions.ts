 ...
 * hunting for the pattern. Future entries: 'genotype_test', 'buy_horse', 'list_horse',
 * 'start_training' - decided in conversation, 2 Aug 2026. */
export type ActionKind = 'book_covering' | 'enter_show' | 'claim_founding';
